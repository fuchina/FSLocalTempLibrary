...
{
   UIButton *button = [self buttonWithFrame:CGRectMake(20, top, WIDTHFC - 40, 44) title:NSLocalizedString(@"Commit", nil) titleColor:[UIColor whiteColor] backColor:FSAPPCOLOR fontInt:0 tag:tag target:target selector:selector];
    button.layer.cornerRadius = 3;
    return button;
}
...
+ (PHTextView *)phTextViewWithFrame:(CGRect)frame placeholder:(NSString *)ph
{
    ...
    textView.textColor = FS_TextColor_Normal;
